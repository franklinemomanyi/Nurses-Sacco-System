        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title"><strong>migorinursessacco@gmail.com</strong></h3>
            ...
            <div class="card-body p-0">
              ...
              <div class="table-responsive mailbox-messages">
                ...
                $connection = imap_open('{imap.gmail.com:993/imap/ssl}INBOX', 'migorinursessacco@gmail.com', 'migori2020') or die('Cannot connect to Gmail: ' . imap_last_error());
                ...
                <table id="frank" class="table table-bordered table-hover">
