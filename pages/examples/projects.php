...
<body class="hold-transition sidebar-mini layout-navbar-fixed sidebar-collapse"><!-- Site wrapper -->
<div class="wrapper">
  <!-- Navbar -->
  <?php
    require('../../nav.php');
              ...
              <tbody>
                ...
                ?>
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="/Nurses/pages/forms/<?php echo $row['4']; ?>" target="_blank">
                          <?php echo $row['3']; ?>
                        </a>
                        <br/>
                          <small>
                              <a href="/Nurses/pages/forms/<?php echo $row['5']; ?>" target="_blank">Compliance</a>
                          </small>
                      </td>
                      <td class="text-center">
                          <?php echo $row1[0]; ?>
