            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <a href="/Nurses/pages/examples/mkpayment.php?idnum=<?php echo $idnum; ?> && tax=<?php echo $tax; ?>" type="button" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Submit
                    Payment
                  </a>
