...
<head>
  ...
  <title>BBF Application Form</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">BBF Application Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="bbfp.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name of Deceased</label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="Name of Deceased" required="">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="exampleInputFile">Death Certificate</label>
                      </div>
