...
<head>
  ...
  <title>Report Upload Form</title>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="reportuploadp.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Report Name</label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="Report Name" required="">
                  </div>
                  ...
                  <label for="exampleInputEmail1">Report Type</label>
                   ...
                   <select name="type" id="type" class="form-control" required="">
                          <option value="0" selected disabled>Which type of Report?</option>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Upload Report(Document)</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="file" id="file" required="" accept=".pdf"/>
                        <label class="custom-file-label" for="exampleInputFile">Upload Report</label>
                      </div>
