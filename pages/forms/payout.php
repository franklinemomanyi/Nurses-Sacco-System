          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Payout Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="payoutp.php" method="post" enctype="multipart/form-data">
                <div class="card-body">

                  <div class="form-group">
                    <label for="exampleInputEmail1">Payee Name</label>
                    <select name="name" id="name" class="form-control" required="">
                      <option value="0" selected disabled>Payee Name?</option>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Reason for Payment</label>
                    <input type="text" class="form-control" name="reason" id="reason" placeholder="" required="">
                  </div>


                  <div class="form-group">
                    <label for="exampleInputFile">Upload Cheque(Scanned)</label>
