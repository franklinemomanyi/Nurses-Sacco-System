...
<head>
  ...
  <title>Migori County Nurses Sacco Ltd.</title>
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php if ($_SESSION['domain'] == '2' OR $_SESSION['domain'] == '2') { ?>
      <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
              ...
              <div class="card-body p-0">
                ...
                <table id="frank" class="table table-striped table-valign-middle">
                  ...
                  if (($_SESSION['domain'] == '0') OR ($_SESSION['domain'] == '1')) {
                    ...
                    $like=$_SESSION['idnum'];
                    $querry="SELECT * FROM LOAN WHERE ACCOUNT LIKE '%$like%' ";
                  }else{
                    echo "Invalid";
                  }
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Loans Applied</span>
                <span class="info-box-number">
                  <?php 
                  $querry3='SELECT COUNT(STATUS) FROM LOAN WHERE STATUS=1';
            ...
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  ...
                  $result3=mysqli_query($conn,$querry3);
                  $row2=mysqli_fetch_array($result3);
                  echo "Ksh.".number_format($row2[0],2);  
                  ?>
                </span>
              </div>
              <!-- /.info-box-content -->
            ...
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <!-- <?php 
                    $querry3='SELECT COUNT(STATUS) FROM LOAN WHERE STATUS=1';
                    $querry4='SELECT COUNT(STATUS) FROM LOAN';
                    $result3=mysqli_query($conn,$querry3);
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <!-- LINE CHART -->
                <h3 class="card-title">Membership Applied</h3>
...
// SELECT COUNT(STATUS) FROM LOAN WHERE STATUS=1

$bjan='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=1 AND YEAR(STAMP)=2020';
$bres1 =mysqli_query($conn,$bjan);
$brow1 =mysqli_fetch_array($bres1);

$bfeb='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=2 AND YEAR(STAMP)=2020';
$bres2 =mysqli_query($conn,$bfeb);
$brow2 =mysqli_fetch_array($bres2);

$bmar='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=3 AND YEAR(STAMP)=2020';
$bres3 =mysqli_query($conn,$bmar);
$brow3 =mysqli_fetch_array($bres3);

$bapr='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=4 AND YEAR(STAMP)=2020';
$bres4 =mysqli_query($conn,$bapr);
$brow4 =mysqli_fetch_array($bres4);

$bmay='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=5 AND YEAR(STAMP)=2020';
$bres5 =mysqli_query($conn,$bmay);
$brow5 =mysqli_fetch_array($bres5);

$bjune='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=6 AND YEAR(STAMP)=2020';
$bres6 =mysqli_query($conn,$bjune);
$brow6 =mysqli_fetch_array($bres6);

$bjuly='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=7 AND YEAR(STAMP)=2020';
$bres7 =mysqli_query($conn,$bjuly);
$brow7 =mysqli_fetch_array($bres7);

$baug='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=8 AND YEAR(STAMP)=2020';
$bres8 =mysqli_query($conn,$baug);
$brow8 =mysqli_fetch_array($bres8);

$bsep='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=9 AND YEAR(STAMP)=2020';
$bres9 =mysqli_query($conn,$bsep);
$brow9 =mysqli_fetch_array($bres9);

$boct='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=10 AND YEAR(STAMP)=2020';
$bres10 =mysqli_query($conn,$boct);
$brow10 =mysqli_fetch_array($bres10);

$bnov='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=11 AND YEAR(STAMP)=2020';
$bres11 =mysqli_query($conn,$bnov);
$brow11 =mysqli_fetch_array($bres11);

$bdec='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=12 AND YEAR(STAMP)=2020';
...
$bajan='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=1 AND STATUS=1';
$bares1 =mysqli_query($conn,$bajan);
$barow1 =mysqli_fetch_array($bares1);

$bafeb='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=2 AND STATUS=1';
$bares2 =mysqli_query($conn,$bafeb);
$barow2 =mysqli_fetch_array($bares2);

$bamar='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=3 AND STATUS=1';
$bares3 =mysqli_query($conn,$bamar);
$barow3 =mysqli_fetch_array($bares3);

$baapr='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=4 AND STATUS=1';
$bares4 =mysqli_query($conn,$baapr);
$barow4 =mysqli_fetch_array($bares4);

$bamay='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=5 AND STATUS=1';
$bares5 =mysqli_query($conn,$bamay);
$barow5 =mysqli_fetch_array($bares5);

$bajune='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=6 AND STATUS=1';
$bares6 =mysqli_query($conn,$bajune);
$barow6 =mysqli_fetch_array($bares6);

$bajuly='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=7 AND STATUS=1';
$bares7 =mysqli_query($conn,$bajuly);
$barow7 =mysqli_fetch_array($bares7);

$baaug='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=8 AND STATUS=1';
$bares8 =mysqli_query($conn,$baaug);
$barow8 =mysqli_fetch_array($bares8);

$basep='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=9 AND STATUS=1';
$bares9 =mysqli_query($conn,$basep);
$barow9 =mysqli_fetch_array($bares9);

$baoct='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=10 AND STATUS=1';
$bares10 =mysqli_query($conn,$baoct);
$barow10 =mysqli_fetch_array($bares10);

$banov='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=11 AND STATUS=1';
$bares11 =mysqli_query($conn,$banov);
$barow11 =mysqli_fetch_array($bares11);

$badec='SELECT COUNT(STATUS) FROM LOAN WHERE MONTH(STAMP)=12 AND STATUS=1';
  ...
  $(function () {
    ...
    var areaChartData = {
      ...
      datasets: [
        ...
        {
          label               : 'LOAN Revenue Non Compliance',
