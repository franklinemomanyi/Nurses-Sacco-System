  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Combined Bar Graph</h1>
          </div><!-- /.col -->
              ...
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    ...
                    <span>Collections/Disbursement</span>
                  </p>
                  <!-- <p class="ml-auto d-flex flex-column text-right">
                    <span class="text-success">
      ...
      datasets: [
        {
          ...
          data: [133,221,783,478,408,547,675,734,133,221,783,478]
        }, {
          label: "Disbursments",
          backgroundColor: "#009999",
          data: [408,547,675,734,133,221,783,478,408,547,675,734]
        }
      ]
    },
    options: {
